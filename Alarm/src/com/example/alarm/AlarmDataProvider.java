...
public class AlarmDataProvider extends ContentProvider {
	...
	private static HashMap<String, String> coordsProjectionMap;
	static {
        sUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);        
        sUriMatcher.addURI(Alarm.AUTHORITY, Alarm.PATH_TIMES, TIMES);
        sUriMatcher.addURI(Alarm.AUTHORITY, Alarm.PATH_COORDS, COORDS);
        
		timesProjectionMap = new HashMap<String, String>();
		timesProjectionMap.put(Alarm.ID, "ID");
		timesProjectionMap.put(Alarm.TIME, "TIME");
		timesProjectionMap.put(Alarm.COORDS, "COORDS");
		
		coordsProjectionMap = new HashMap<String, String>();
		coordsProjectionMap.put(Alarm.ID, "ID");
		coordsProjectionMap.put(Alarm.COORDS, "COORDS");
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case TIMES:
			qb.setTables(Alarm.TABLE_NAME_ALARMS);
			qb.setProjectionMap(timesProjectionMap);
			break;
		case COORDS:
			qb.setTables(Alarm.TABLE_NAME_COORDS);
			qb.setProjectionMap(coordsProjectionMap);
			break;
		default:
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		...
		case TIMES:
			...
			tableName = Alarm.TABLE_NAME_ALARMS;
		case COORDS:
		...
		long rowId = db.insert(tableName, 	"ID", 	values );
